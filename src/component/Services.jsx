...
const handleMouseEnter = (e) => {
    ...
    e.currentTarget.querySelector('i').style.transition = 'all 0.3s ease';
    e.currentTarget.querySelector('i').style.transform = 'scale(1.2)';
    e.currentTarget.querySelector('i').style.backgroundColor = 'black'
...
const handleMouseLeave = (e) => {
    ...
    e.currentTarget.querySelector('i').style.backgroundColor = 'white'
        ...
        <div className="container text-center">
            ...
            <div className="row d-flex justify-content-evenly flex-wrap mt-5">
                <div className="col-lg-4 col-md-4 mb-md-1 mb-sm-5 ">
                                <div className="shadow py-5 px-3" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                                    <i className="fs-4 p-3 rounded-circle bg-gray fa-solid fa-laptop fs-3 mb-3 rounded-circle p-4" />
                            ...
                            <div className="col-lg-4 col-md-4 mb-md-1 mb-sm-5">
                                <div className="shadow py-5 px-3" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                                    <i className="fa-solid fa-bullhorn fs-3 mb-3 rounded-circle p-4"  />
                            ...
                            <div className="col-lg-4 col-md-4 mb-md-1 mb-sm-5">
                                <div className="shadow py-5 px-3" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                                    <i className="fa-solid fa-umbrella fs-3 mb-3 rounded-circle p-4"  />
                        ...
                        <div className="row d-flex justify-content-evenly flex-wrap mt-5">
                            <div className="col-lg-4 col-md-4 mb-md-1 mb-sm-5 ">
                                <div className="shadow py-5 px-3" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                                    <i className="fa-regular fa-gem fs-3 mb-3 rounded-circle p-4"  />
                            ...
                            <div className="col-lg-4 col-md-4 mb-md-1 mb-sm-5">
                                <div className="shadow py-5 px-3" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                                    <i className="fa-solid fa-display fs-3 mb-3 rounded-circle p-4"  />
                            ...
                            <div className="col-lg-4 col-md-4 mb-md-1 mb-sm-5">
                                <div className="shadow py-5 px-3" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                                    <i className="fa-solid fa-camera fs-3 mb-3 rounded-circle p-4"  />
